...
const QMetaObject MyDialog1::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_MyDialog1.data,
      qt_meta_data_MyDialog1,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *MyDialog1::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MyDialog1.stringdata0))
        return static_cast<void*>(const_cast< MyDialog1*>(this));
